...
public class Const {
    ...
    public static String PATH_PAGE_NEW_ITEM = PATH_PRIVATE + "newProduct.jsp";
    ...
    public static String PATH_PAGE_INVOICE_LIST = PATH_PRIVATE + "ListOrders.jsp";
    ...
    public static String PATH_PAGE_LISTCATEGORY = PATH_PRIVATE + "listCategories.jsp";
    public static String PATH_PAGE_WARNING_DELETE_PRODUCT = PATH_PRIVATE + "warningDeleteItem.jsp";
    public static String PATH_PAGE_WARNING_DELETE_CATEGORY = PATH_PRIVATE + "warningDeleteCategory.jsp";
    public static String PATH_PAGE_WARNING_TOOGLE_ORDER = PATH_PRIVATE + "warningToogleOrderStatus.jsp";
    ...
    public static String PATH_PAGE_WARNING_DELETE_ORDER = PATH_PRIVATE + "warningDeleteOrder.jsp";
    public static String PATH_PAGE_LISTUSER = PATH_PRIVATE + "listUser.jsp";
    // Index
